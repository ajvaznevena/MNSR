...
U ovom radu ćemo se na početku upoznati sa pojmom sajber kriminala\cite{kriminal}, kao i problemom rasprostranjenosti sajber napada. Dalje će biti prikazani problemi najvećih svetskih kompanija \cite{kompanije} i država \cite{knjiga}, i kako su se one suočavale sa tim. Sajber kriminal brzo napreduje, što prouzrokuje razvoj i nastanak novih vrsta napada. U petom poglavlju obrađena je tema koja se odnosi na 3 najčešće vrste napada - fišing, SQL injekcija \cite{sql_injection} i DoS. Nakon ovoga, pozabavićemo se temom glasanja putem Interneta.
